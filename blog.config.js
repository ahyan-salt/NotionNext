...
const BLOG = {
  ...
  CONTACT_EMAIL: 'uaiiji@hotmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '人死在世', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '難得思考了不如寫長點。', // 站点描述，被notion中的页面描述覆盖
